"""Обработка команд Kafka (шаг testing)."""
...
from .service import _execute_test_run
...
async def _handle_command(payload: dict[str, Any]) -> None:
    ...
    try:
        ...
        await _execute_test_run(run_id, project_id)
        ...
        logger.exception("Ошибка testing по Kafka")
        err = str(exc)
